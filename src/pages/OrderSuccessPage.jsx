    ...
    <div className="min-h-screen bg-white px-4 sm:px-6 py-12 sm:py-16">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex justify-center mb-6">
          <div className="w-14 h-14 rounded-full bg-amber-700/80 flex items-center justify-center">
        ...
        <div className="border border-gray-200 rounded-md px-6 py-6">
          <h2 className="text-xs font-semibold tracking-widest text-gray-900 mb-5">
            ORDER DETAILS
          </h2>

          {/* Product header */}
          <div className="flex justify-between text-xs font-semibold tracking-widest text-gray-900 border-b border-gray-200 pb-3 mb-3">
            <span>PRODUCT</span>
            <span>SUBTOTAL</span>
          </div>
...
function SummaryRow({ label, value, bold, noBorder }) {
  return (
    ...
    >
      <span
        className={`text-xs tracking-widest text-gray-900 ${
