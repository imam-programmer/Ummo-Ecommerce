...
//                 <ul className='flex justify-center flex-wrap md:gap-13.5  gap-x-3 gap-y-2 mb-5 lg:mb-10 mt-3 lg:mt-7.5'>
...
//                 </ul>
//                 <div className='grid  justify-center  bmd:grid-cols-3  grid-cols-2 sm:grid-cols-3 xl:grid-cols-4 gap-2 bmd:gap-x-1  lg:gap-x-2'>
